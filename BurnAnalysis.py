...
def burn_calculation(circulating=580.828875377658,target_mc=1, target_price=0.001,limit = 10000,override=False):
    ...
    while required_burn > burn_wallet:
        ...
        print("Ending Value:",int(round(investment*target_price/average_buy,0)))
        print("CAGR:",round(pow(target_price/average_buy,1/(int(current_date.strftime("%Y"))/365))-1,0)*100,"%")
